...
public class HelloCheckBox extends JFrame {
    ...
    public HelloCheckBox(){
        ...
        JCheckBox checkBox = new JCheckBox("Saya Menyutujui Syarat dan Ketentuan Yang Berlaku");
        checkBox.setBounds(15, 100, 350, 40);

        JButton button = new JButton("SIMPAN");
        button.setBounds(115, 150, 100, 40);
